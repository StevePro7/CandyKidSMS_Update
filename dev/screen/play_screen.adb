...
S:Lplay_screen.screen_play_screen_update$eo$1$73({2}DG,STtag_struct_enemy_object:S),B,1,-12
...
S:Lplay_screen.screen_play_screen_update$frame$1$73({2}SI:U),B,1,-10
S:Lplay_screen.screen_play_screen_update$sloc0$1$0({1}SC:U),B,1,-5
S:Lplay_screen.screen_play_screen_update$sloc1$1$0({2}DG,SC:U),B,1,-2
S:Lplay_screen.screen_play_screen_update$sloc2$1$0({2}DG,SC:U),B,1,-7
S:Lplay_screen.screen_play_screen_update$sloc3$1$0({2}DG,SC:U),B,1,-4
