...
S:Lcollision_manager.engine_collision_manager_enemy_collision$sloc1$1$0({2}DG,SC:U),B,1,-5
S:Lcollision_manager.engine_collision_manager_enemy_collision$sloc2$1$0({1}SC:U),B,1,-1
S:Lcollision_manager.engine_collision_manager_enemy_collision$sloc3$1$0({1}SC:U),B,1,-2
...
S:Lcollision_manager.engine_collision_manager_boss_collision$gamer_collision$1$82({1}SC:U),B,1,-8
S:Lcollision_manager.engine_collision_manager_boss_collision$bossX$1$82({1}SC:U),B,1,-9
S:Lcollision_manager.engine_collision_manager_boss_collision$sloc0$1$0({1}SC:U),B,1,-8
S:Lcollision_manager.engine_collision_manager_boss_collision$sloc1$1$0({1}SC:U),B,1,-9
S:Lcollision_manager.engine_collision_manager_boss_collision$sloc2$1$0({1}SC:U),B,1,-1
S:Lcollision_manager.engine_collision_manager_boss_collision$sloc3$1$0({1}SC:U),B,1,-10
S:Lcollision_manager.engine_collision_manager_boss_collision$sloc4$1$0({2}SI:S),B,1,-3
S:Lcollision_manager.engine_collision_manager_boss_collision$sloc5$1$0({2}SI:S),B,1,-7
S:Lcollision_manager.engine_collision_manager_boss_collision$sloc6$1$0({2}SI:S),B,1,-5
S:Lcollision_manager.engine_collision_manager_boss_collision$sloc7$1$0({2}SI:S),B,1,-12
